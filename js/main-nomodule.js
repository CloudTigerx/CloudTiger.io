...
// Simple, direct approach for Drop button
...
// This creates a global variable and modifies the game loop
(function() {
    ...
    window.setInterval = function(callback, delay) {
        if (delay > 400 && delay < 2000) {
            const intervalId = originalSetInterval(function() {
                // Check each time the interval runs
                if (window.SOFT_DROP_ACTIVE) {
                    // Run callback more often when drop is active
